...
static void DSynth_process(DSynth *self, ALuint SamplesToDo, ALfloat(*DryBuffer)[BUFFERSIZE]);
...
static void DSynth_process(DSynth *self, ALuint SamplesToDo, ALfloatBUFFERSIZE*UNUSED(DryBuffer))
{
