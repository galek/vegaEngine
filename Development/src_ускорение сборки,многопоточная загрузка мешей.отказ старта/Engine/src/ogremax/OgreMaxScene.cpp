...
//Includes---------------------------------------------------------------------
#include "ogremax/OgreMaxScene.h"
#include "ogremax/OgreMaxUtilities.h"/*
...
namespace vega
{
	...
	{
	public:
		SceneModelInstanceCallback(LevelLoader* scene, LevelLoaderCallback* sceneCallback)
		{
			this->scene = scene;
	...
	private:
		LevelLoader* scene;
		LevelLoaderCallback* sceneCallback;
	};
	...
	float LevelLoader::DEFAULT_MAX_DISTANCE = 100000.0f;
	...
	void LevelLoader::Update(Real elapsedTime)
	{
	...
	const String& LevelLoader::GetBaseResourceLocation() const
	{
		return this->baseResourceLocation;
	}

	void LevelLoader::SetBaseResourceLocation(const String& directory)
	{
	...
	void LevelLoader::Destroy()
	{
		...
		this->currentRenderTextureIndex = 0;
		this->baseResourceLocation = Ogre::BLANKSTRING;
		this->loadedFromFileSystem = false;
	}

	void LevelLoader::SetNamePrefix(const String& name, WhichNamePrefix prefixes)
	{
	...
	Ogre::SceneManager* LevelLoader::GetSceneManager()
	{
		return this->sceneManager;
	}

	Ogre::SceneNode* LevelLoader::GetRootNode()
	{
		return this->rootNode;
	}

	SceneNode* LevelLoader::GetSkyNode()
	{
		return this->skyNode;
	}

	SceneNode* LevelLoader::GetSceneNode(const String& name, bool nameIncludesPrefix)
	{
		SceneNode* node = 0;
	...
	Entity* LevelLoader::GetEntity(const String& name, bool nameIncludesPrefix)
	{
		Entity* entity = 0;
	...
	Camera* LevelLoader::GetCamera(const String& name, bool nameIncludesPrefix)
	{
		Camera* camera = 0;
	...
	UpAxis LevelLoader::GetUpAxis() const
	{
		return this->upAxis;
	}

	const Vector3& LevelLoader::GetUpVector() const
	{
		return this->upAxis == UP_AXIS_Y ? Vector3::UNIT_Y : Vector3::UNIT_Z;
	}

	Real LevelLoader::GetUnitsPerMeter()
	{
		return this->unitsPerMeter;
	}

	const String LevelLoader::GetUnitType()
	{
		return this->unitType;
	}

	const String& LevelLoader::GetAuthor() const
	{
		return this->author;
	}

	const String& LevelLoader::GetApplication() const
	{
		return this->application;
	}

	const ObjectExtraData& LevelLoader::GetSceneExtraData() const
	{
		return this->sceneExtraData;
	}

	const ObjectExtraData& LevelLoader::GetTerrainExtraData() const
	{
		return this->terrainExtraData;
	}

	const ObjectExtraData& LevelLoader::GetSkyBoxExtraData() const
	{
		return this->skyBoxExtraData;
	}

	const ObjectExtraData& LevelLoader::GetSkyDomeExtraData() const
	{
		return this->skyDomeExtraData;
	}

	const ObjectExtraData& LevelLoader::GetSkyPlaneExtraData() const
	{
		return this->skyPlaneExtraData;
	}

	const LevelLoader::ExternalItemList& LevelLoader::GetExternalItems() const
	{
		return this->externalItems;
	}

	const LevelLoader::ExternalUserDataVector& LevelLoader::GetExternalUserData() const
	{
		return this->externalUserDatas;
	}

	const ColourValue& LevelLoader::GetBackgroundColor() const
	{
		return this->backgroundColor;
	}

	Real LevelLoader::GetEnvironmentNear() const
	{
		return this->environmentNear;
	}

	const FogParameters& LevelLoader::GetFogParameters() const
	{
		return this->fogParameters;
	}

	Real LevelLoader::GetEnvironmentFar() const
	{
		return this->environmentFar;
	}

	MovablePlane* LevelLoader::GetShadowOptimalPlane()
	{
		return this->shadowOptimalPlane;
	}

	MovablePlane* LevelLoader::GetMovablePlane(const String& name)
	{
	...
	LevelLoader::AnimationStates& LevelLoader::GetAnimationStates()
	{
		return this->animationStates;
	}

	AnimationState* LevelLoader::GetAnimationState(const String& animationName)
	{
	...
	LevelLoader::ObjectExtraDataMap& LevelLoader::GetAllObjectExtraData()
	{
		return this->allObjectExtraData;
	}

	LevelLoader::NodeObjectExtraDataMap& LevelLoader::GetAllNodeObjectExtraData()
	{
		return this->allNodeObjectExtraData;
	}

	const LevelLoader::ModelMap& LevelLoader::GetModelMap() const
	{
		return this->modelMap;
	}

	OgreMaxModel* LevelLoader::GetModel(const String& fileName)
	{
	...
	const FlagAliases& LevelLoader::GetQueryFlagAliases() const
	{
		return this->queryFlags;
	}

	const FlagAliases& LevelLoader::GetVisibilityFlagAliases() const
	{
		return this->visibilityFlags;
	}

	ObjectExtraData* LevelLoader::GetObjectExtraData(const MovableObject* object) const
	{
	...
	Types::ObjectExtraData* LevelLoader::GetObjectExtraData(const Ogre::Node* node) const
	{
	...
	const LevelLoader::ResourceLocations& LevelLoader::GetResourceLocations() const
	{
		return this->resourceLocations;
	}

	Ogre::ResourceLoadingListener& LevelLoader::GetResourceLoadingListener()
	{
		return this->resourceLoadingListener;
	}

	void LevelLoader::HandleNewObjectExtraData(ObjectExtraDataPtr objectExtraData)
	{
		bool hasOwner =
	...
	void LevelLoader::DestroyedSceneNode(const SceneNode* node)
	{
	...
	void LevelLoader::DestroyedObject(const MovableObject* object)
	{
	...
	void LevelLoader::preRenderTargetUpdate(const RenderTargetEvent& e)
	{
	...
	void LevelLoader::postRenderTargetUpdate(const RenderTargetEvent& e)
	{
		RenderTargetMap::iterator renderTarget = this->renderTargets.find(e.source);
		if (renderTarget != this->renderTargets.end())
		{
	...
	String LevelLoader::GetNewObjectName(const TiXmlElement* objectElement, SceneNode* node)
	{
	...
	void LevelLoader::UpdateLoadProgress(ProgressCalculator* calculator, Real amount)
	{
	...
	void LevelLoader::LoadScene(const TiXmlElement* objectElement)
	{
	...
	void LevelLoader::FinishLoadingLookAndTrackTargets()
	{
	...
	void LevelLoader::LoadInstancedGeometries(const TiXmlElement* objectElement)
	{
		...
		if (!Root::getSingleton().getRenderSystem()->getCapabilities()->hasCapability(RSC_VERTEX_PROGRAM))
		{
			OGRE_EXCEPT
				...
				"LevelLoader::LoadInstancedGeometry"
				);
		}
	...
	void LevelLoader::LoadInstancedGeometry(const TiXmlElement* objectElement)
	{
		String name = OgreMaxUtilities::GetStringAttribute(objectElement, "name");
	...
	void LevelLoader::LoadInstancedGeometryEntity(const TiXmlElement* objectElement, InstancedGeometry* instancedGeometry)
	{
	...
	void LevelLoader::LoadStaticGeometries(const TiXmlElement* objectElement)
	{
	...
	void LevelLoader::LoadStaticGeometry(const TiXmlElement* objectElement)
	{
		String name = OgreMaxUtilities::GetStringAttribute(objectElement, "name");
		bool castShadows = OgreMaxUtilities::GetBoolAttribute(objectElement, "castShadows", true);
		ObjectVisibility visibility = OgreMaxUtilities::GetObjectVisibilityAttribute(objectElement, "visible");
	...
	void LevelLoader::LoadStaticGeometryEntity(const TiXmlElement* objectElement, StaticGeometry* staticGeometry)
	{
	...
	void LevelLoader::LoadPortalConnectedZones(const TiXmlElement* objectElement)
	{
	...
	bool LevelLoader::LoadResourceLocations(const TiXmlElement* objectElement)
	{
	...
	bool LevelLoader::AddResourceLocation(const ResourceLocation& resourceLocation)
	{
	...
	void LevelLoader::CommitResourceLocations()
	{
	...
	void LevelLoader::LoadQueryFlagAliases(const TiXmlElement* objectElement)
	{
	...
	void LevelLoader::LoadVisibilityFlagAliases(const TiXmlElement* objectElement)
	{
		//Exit early if skip option is set
	...
	void LevelLoader::LoadNodes(const TiXmlElement* objectElement)
	{
		//Exit early if skip option is set
	...
	void LevelLoader::LoadExternals(const TiXmlElement* objectElement)
	{
		//Exit early if skip option is set
	...
	void LevelLoader::LoadExternalUserDatas(const TiXmlElement* objectElement)
	{
		//Initialize progress counter
		size_t oldSize = this->externalItems.size();
	...
	void LevelLoader::LoadEnvironment(const TiXmlElement* objectElement)
	{
		//Exit early if skip option is set
	...
	void LevelLoader::LoadRenderTextures(const TiXmlElement* objectElement)
	{
	...
	void LevelLoader::FinishLoadingRenderTextures()
	{
	...
	void LevelLoader::GetRenderTextureObjects(LoadedRenderTexture* loadedRenderTexture)
	{
		const RenderTextureParameters& renderTextureParams = loadedRenderTexture->parameters;
	...
	void LevelLoader::LoadTerrain(const TiXmlElement* objectElement)
	{
		//Exit early if skip option is set
	...
	void LevelLoader::LoadNode(const TiXmlElement* objectElement, SceneNode* parentNode)
	{
	...
	void LevelLoader::LoadFog(const TiXmlElement* objectElement)
	{
	...
	void LevelLoader::LoadSkyBox(const TiXmlElement* objectElement)
	{
		//Exit early if skip option is set
	...
	void LevelLoader::LoadSkyDome(const TiXmlElement* objectElement)
	{
		//Exit early if skip option is set
		if ((this->loadOptions & SKIP_SKY) != 0)
			return;
	...
	void LevelLoader::LoadSkyPlane(const TiXmlElement* objectElement)
	{
		//Exit early if skip option is set
		if ((this->loadOptions & SKIP_SKY) != 0)
			return;
	...
	void LevelLoader::LoadShadows(const TiXmlElement* objectElement)
	{
		//Exit early if skip option is set
	...
	void LevelLoader::LoadExternalItem(const TiXmlElement* objectElement, ExternalItem& item)
	{
	...
	void LevelLoader::LoadExternalUserData(const TiXmlElement* objectElement, ExternalUserData& userData)
	{
	...
	void LevelLoader::LoadEntity(const TiXmlElement* objectElement, const MovableObjectOwner& owner)
	{
	...
	void LevelLoader::LoadLight(const TiXmlElement* objectElement, const MovableObjectOwner& owner)
	{
		ObjectExtraDataPtr objectExtraData(new ObjectExtraData);
	...
	void LevelLoader::LoadCamera(const TiXmlElement* objectElement, const MovableObjectOwner& owner)
	{
		ObjectExtraDataPtr objectExtraData(new ObjectExtraData);
	...
	void LevelLoader::LoadParticleSystem(const TiXmlElement* objectElement, const MovableObjectOwner& owner)
	{
		ObjectExtraDataPtr objectExtraData(new ObjectExtraData);
	...
	void LevelLoader::LoadBillboardSet(const TiXmlElement* objectElement, const MovableObjectOwner& owner)
	{
		ObjectExtraDataPtr objectExtraData(new ObjectExtraData);
	...
	void LevelLoader::LoadPlane(const TiXmlElement* objectElement, const MovableObjectOwner& owner)
	{
		ObjectExtraDataPtr objectExtraData(new ObjectExtraData);
	...
	void LevelLoader::LoadBoneAttachments(const TiXmlElement* objectElement, Entity* entity)
	{
		const TiXmlElement* childElement = 0;
		while (childElement = OgreMaxUtilities::IterateChildElements(objectElement, childElement))
	...
	void LevelLoader::LoadBoneAttachment(const TiXmlElement* objectElement, Entity* entity)
	{
	...
	void LevelLoader::LoadLookTarget(const TiXmlElement* objectElement, SceneNode* node, Camera* camera)
	{
	...
	void LevelLoader::LoadTrackTarget(const TiXmlElement* objectElement, SceneNode* node, Camera* camera)
	{
	...
	void LevelLoader::LoadBillboard(const TiXmlElement* objectElement, BillboardSet* billboardSet)
	{
	...
	void LevelLoader::LoadLightRange(const TiXmlElement* objectElement, Light* light)
	{
	...
	void LevelLoader::LoadLightAttenuation(const TiXmlElement* objectElement, Light* light)
	{
		String value;
	...
	void LevelLoader::LoadNodeAnimations(const TiXmlElement* objectElement, SceneNode* node)
	{
		//Parse child elements
		String elementName;
		const TiXmlElement* childElement = 0;
	...
	void LevelLoader::LoadNodeAnimation(const TiXmlElement* objectElement, SceneNode* node)
	{
	...
	void LevelLoader::LoadNodeAnimationKeyFrame(const TiXmlElement* objectElement, NodeAnimationTrack* animationTrack)
	{
		//Key time
	...
	void LevelLoader::LoadObjectNames(const TiXmlElement* objectElement, const String& elementName, std::vector<String>& names)
	{
	...
	void LevelLoader::LoadRenderTextureMaterials
		(
	...
	ShadowCameraSetup* LevelLoader::ParseShadowCameraSetup(const String& type, Plane optimalPlane)
	{
		...
		OGRE_EXCEPT
			...
			Exception::ERR_INVALIDPARAMS,
			errorMessage.str(),
			"LevelLoader::ParseShadowCameraSetup"
			);
	}
}