...
#include "ogremax/OgreMaxPlatform.h"
#include "ogremax/ProgressCalculator.h"
#include "ogremax/OgreMaxTypes.h"
...
namespace vega
{
    ...
    public:
         ...
         */
        static void ResetResourceGroups(const Ogre::String& createResourceGroup = Ogre::BLANKSTRING);
