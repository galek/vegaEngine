...
namespace Launcher
{
	static class Program
	{
		...
		static int Main( string[] Arguments )
		{
			...
			// Parse the executable name to remove the 'Launcher' component...
			...
			// Parse out the 'Lift'
			ExecutableName = ExecutableName.Replace( "Laucnher.", "." );
			...
			try
			{
                ...
                string BitFolder = "Binaries.Win32\\";
				if( IntPtr.Size == 8 )
				{
                    BitFolder = "Binaries.Win64\\";
				}
				...
				{
					// Can we write a file?
					String TestFilename = BinariesFolder + "VEGA_" + Guid.NewGuid().ToString() + ".tmp";
