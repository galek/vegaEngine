...
extern Math* mth;
extern LodStrategyManager* lodMgr;
extern MaterialManager* matMgr;
extern SkeletonManager* skelMgr;
extern MeshSerializer* meshSerializer;
extern SkeletonSerializer* skeletonSerializer;
extern DefaultHardwareBufferManager *bufferManager;
extern ResourceGroupManager* rgm;
...
int MU_Main(int numargs, char** args)
{
	//NickGalko:Потом перенести
    if (numargs < 2)
    {
        MU_help();
        return -1;
