...
namespace vega{ namespace VClouds{
	...
	public:
		 ...
		 */
		FORCEINLINE void setUpdateTime(const float& UpdateTime)
		{
		...
		/** Get update time
		    @return Update time
		 */
		FORCEINLINE const Ogre::Real& getUpdateTime() const
		{
			return mUpdateTime;
		}
		 ...
		 */
		FORCEINLINE const Ogre::Real _getInterpolation() const
		{
