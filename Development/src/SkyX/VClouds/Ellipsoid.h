...
namespace vega{ namespace VClouds{
	...
	public:
		 ...
		 */
		FORCEINLINE const Ogre::Vector3 getDimensions() const
		{
		...
		/** Get position
		    @return Position
		 */
		FORCEINLINE const Ogre::Vector3 getPosition() const
		{
		 ...
		 */
		FORCEINLINE void setPosition(const Ogre::Vector3& Position)
		{
			mX = Position.x;
			mY = Position.y;
			mZ = Position.z;
