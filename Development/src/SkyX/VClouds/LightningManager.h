...
namespace vega{ namespace VClouds{
	...
	public:
		...
		public:
			 ...
			 */
			FORCEINLINE virtual void lightningAdded(Lightning* l){}
		};
		 ...
		 */
		FORCEINLINE void addListener(Listener* listener)
		{
		...
		/** Remove listeners
		 */
		FORCEINLINE void removeListeners()
		{
			mListeners.clear();
		}
		...
		/** Get listeners
		    @return Listeners
		 */
		FORCEINLINE const std::vector<Listener*>& getListeners() const
		{
			return mListeners;
		}
		 ...
		 */
		FORCEINLINE const Ogre::Vector3& getLightningColor() const
		{
		 ...
		 */
		FORCEINLINE const Ogre::Real& getLightningTimeMultiplier() const
		{
		 ...
		 */
		FORCEINLINE void setAverageLightningApparitionTime(const Ogre::Real& alat)
		{
		 ...
		 */
		FORCEINLINE const Ogre::Real& getAverageLightningApparitionTime() const
		{
