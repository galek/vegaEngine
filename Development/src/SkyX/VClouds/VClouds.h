...
namespace vega{ namespace VClouds{
	...
	public:
		...
		struct RenderQueueGroups
		{
			 ...
			 */
			FORCEINLINE RenderQueueGroups(const Ogre::uint8& vc, const Ogre::uint8& vclu, const Ogre::uint8& vclo)
		...
		public:
			...
			/** Constructor
			    @param c Camera
			 */
			FORCEINLINE CameraData(Ogre::Camera* c)
				: camera(c)
		 ...
		 */
		FORCEINLINE void setGeometrySettings(const GeometrySettings& gs)
		{
		 ...
		 */
		FORCEINLINE const GeometrySettings& getGeometrySettings() const
		{
		...
		*/
		FORCEINLINE void setDistanceFallingParams(const Ogre::Vector2& DistanceFallingParams)
		{
		...
		/** Get distance falling params
			...
			@remarks See GoemetryBlock::_setVertexData(...) for more info
		 */
		FORCEINLINE const Ogre::Vector2& getDistanceFallingParams() const
		{
		 ...
		 */
		FORCEINLINE const RenderQueueGroups& getRenderQueueGroups() const
		{
		 ...
		 */
		FORCEINLINE void setWindDirection(const Ogre::Radian& WindDirection)
		{
		 ...
		 */
		FORCEINLINE const Ogre::Radian& getWindDirection() const
		{
		...
		/** Get wind direction as a Vector2
		    @return Wind direction
		 */
		FORCEINLINE const Ogre::Vector2 getWindDirectionV2() const
		{
		 ...
		 */
		FORCEINLINE void setWindSpeed(const float& WindSpeed)
		{
		...
		/** Get wind speed
		    @return Wind speed
		 */
		FORCEINLINE const float& getWindSpeed() const
		{
			return mWindSpeed;
		}
		 ...
		 */
		FORCEINLINE void setSunDirection(const Ogre::Vector3& SunDirection)
		{
		 ...
		 */
		FORCEINLINE const Ogre::Vector3& getSunDirection() const
		{
		...
		/** Get sun color
		    @return Sun color
		 */
		FORCEINLINE const Ogre::Vector3& getSunColor() const
		{
			return mSunColor;
		}
		 ...
		 */
		FORCEINLINE const Ogre::Vector3& getAmbientColor() const
		{
		 ...
		 */
		FORCEINLINE const Ogre::Vector4& getLightResponse() const
		{
		 ...
		 */
		FORCEINLINE const Ogre::Vector4& getAmbientFactors() const
		{
		 ...
		 */
		FORCEINLINE void setGlobalOpacity(const Ogre::Real& GlobalOpacity)
		{
		 ...
		 */
		FORCEINLINE const Ogre::Real& getGlobalOpacity() const
		{
		 ...
		 */
		FORCEINLINE void setCloudFieldScale(const Ogre::Real& CloudFieldScale)
		{
		 ...
		 */
		FORCEINLINE const Ogre::Real& getCloudFieldScale() const
		{
		 ...
		 */
		FORCEINLINE void setNoiseScale(const Ogre::Real& NoiseScale)
		{
		...
		/** Get noise scale
		    @return Noise scale
		 */
		FORCEINLINE const Ogre::Real& getNoiseScale() const
		{
			return mNoiseScale;
		}
		 ...
		 */
		FORCEINLINE const Ogre::Vector2& getWheater() const
		{
			return mWheater;
		}
		 ...
		 */
		FORCEINLINE const bool& isVisible() const
		{
			return mVisible;
		}
		 ...
		 */
		FORCEINLINE Ogre::SceneManager* getSceneManager()
		{
		 ...
		 */
		FORCEINLINE Ogre::Camera* getCamera()
		{
            return mCamera;
		}
		...
		/** Get data manager
		    @return Data manager
		 */
		FORCEINLINE DataManager* getDataManager()
		{
			return mDataManager;
		}
		 ...
		 */
		FORCEINLINE GeometryManager* getGeometryManager()
		{
		 ...
		 */
		FORCEINLINE LightningManager* getLightningManager()
		{
		 ...
		 */
		FORCEINLINE std::vector<CameraData>& _getCamerasData()
		{
			return mCamerasData;
		}
	...
	private:
		...
		/// Vol. clouds material
		Ogre::Material* mVolCloudsMaterial;
		/// Vol. clouds + lightning material
		Ogre::Material* mVolCloudsLightningMaterial;
