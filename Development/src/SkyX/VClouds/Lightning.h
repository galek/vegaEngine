...
namespace vega{ namespace VClouds{
	...
	public:
		 ...
		 */
		FORCEINLINE const Ogre::Vector3& getDirection() const
		{
			return mDirection;
		}
		...
		/** Get ray length
		    @return Ray length
		 */
		FORCEINLINE const Ogre::Real& getLength() const
		{
			return mLength;
		}
		 ...
		 */
		FORCEINLINE const Ogre::Real& getIntensity() const
		{
			return mIntensity;
		}
		 ...
		 */
		FORCEINLINE Ogre::BillboardSet* getBillboardSet() const
		{
		...
		/** Get scene node
		    @return Scene node
		 */
		FORCEINLINE Ogre::SceneNode* getSceneNode() const
		{
			return mSceneNode;
		}
		 ...
		 */
		FORCEINLINE const bool& isFinished() const
		{
			return mFinished;
		}
