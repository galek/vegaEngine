...
namespace vega
{
	...
	public:
		 ...
		 */
		FORCEINLINE void setAmbientGradient(const ColorGradient& AmbientGradient)
		{
		 ...
		 */
		FORCEINLINE const ColorGradient& getAmbientGradient() const
		{
		 ...
		 */
		FORCEINLINE void setSunGradient(const ColorGradient& SunGradient)
		{
		 ...
		 */
		FORCEINLINE const ColorGradient& getSunGradient() const
		{
			return mSunGradient;
		}
		 ...
		 */
		FORCEINLINE void setHeight(const Ogre::Vector2& Height)
		{
			mHeight = Height;
		}
		 ...
		 */
		FORCEINLINE const Ogre::Vector2& getHeight() const
		{
			return mHeight;
		}
		 ...
		 */
		FORCEINLINE void setAutoupdate(const bool& Autoupdate) 
		{
		 ...
		 */
		FORCEINLINE const bool& getAutoupdate() const
		{
			return mAutoupdate;
		}
		 ...
		 */
		FORCEINLINE void setWindSpeed(const Ogre::Real& WindSpeed)
		{
		...
		/** Get wind speed
		    @return Wind speed
		 */
		FORCEINLINE const Ogre::Real& getWindSpeed() const
		{
			return mWindSpeed;
		}
		...
		/** Get VClouds
		 */
		FORCEINLINE VClouds::VClouds* getVClouds()
		{
			return mVClouds;
		}
