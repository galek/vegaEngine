...
namespace vega
{
	...
	public:
		 ...
		 */
		FORCEINLINE const Ogre::String getMoonMaterialName() const
		{
			return "SkyX_Moon";
		}
		...
		/** Notify skydome material changed
		    @remarks Only for internal use
		 */
		FORCEINLINE void _notifySkydomeMaterialChanged()
		{
			...
			{
				SkyXLOG("Error in vega::GPUManager: '" + getSkydomeMaterialName() + "' material not found");
				return;
			}
		}
