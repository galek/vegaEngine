...
namespace vega
{
	...
	public:
		 ...
		 */
		FORCEINLINE Controller(const bool& deleteBySkyX)
		...
		/** Destructor
		 */
		FORCEINLINE virtual ~Controller(){}
		 ...
		 */
		FORCEINLINE virtual void update(const Ogre::Real& simDeltaTime){}
		 ...
		 */
		FORCEINLINE const bool& getDeleteBySkyX() const
		{
