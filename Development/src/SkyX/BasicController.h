...
namespace vega
{
	...
	public:
		 ...
		 */
		FORCEINLINE void setTime(const Ogre::Vector3& t)
		{
			mTime = t;
			update(0);
		}
		 ...
		 */
		FORCEINLINE const Ogre::Vector3& getTime() const
		{
			return mTime;
		}
		 ...
		 */
		FORCEINLINE void setEastDirection(const Ogre::Vector2& ed)
		{
			mEastDirection = ed;
			update(0);
		}
		 ...
		 */
		FORCEINLINE const Ogre::Vector2& getEastDirection() const
		{
		 ...
		 */
		FORCEINLINE Ogre::Vector3 getSunDirection()
		{
		 ...
		 */
		FORCEINLINE Ogre::Vector3 getMoonDirection()
		{
		 ...
		 */
		FORCEINLINE void setMoonPhase(const Ogre::Real& mp)
		{
			mMoonPhase = mp;
		}
		 ...
		 */
		FORCEINLINE Ogre::Real getMoonPhase()
		{
			return mMoonPhase;
		}
