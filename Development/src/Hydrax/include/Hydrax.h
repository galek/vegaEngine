...
#include "../Core/inc/EngineConfig.h"
...
namespace vega
{
	...
	public:
		/** Constructor
			...
			*/
		Hydrax(EngineConfig::RenderAPI&, Ogre::SceneManager *sm, Ogre::Camera *c, Ogre::Viewport *v);
		...
		/** Get MaterialManager
			@return MaterialManager pointer
			*/
		...
		/** Get GPUNormalMapManager
			@return GPUNormalMapManager pointer
			*/
		...
		/** Get our Module::Module
			@return Module::Module pointer or NULL if Module isn't set.
			*/
	...
	private:
		...
		/// Our TextureManager pointer
		TextureManager *mTextureManager;
		/// Our GodRaysManager pointer
		GodRaysManager *mGodRaysManager;
		/// Our DecalsManager pointer
		DecalsManager *mDecalsManager;
		/// Our GPUNormalMapManager pointer
		GPUNormalMapManager *mGPUNormalMapManager;
		/// Our CfgFileManager pointer
		CfgFileManager *mCfgFileManager;
		/// Our Module::Module pointer
