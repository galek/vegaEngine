...
namespace vega
{
	...
	void wxDefaultDockArt::DrawSash(wxDC& dc, int orientation, const wxRect& rect)
	{
#ifdef __WXMAC__
	...
	void wxDefaultDockArt::DrawBackground(wxDC& dc, int orientation, const wxRect& rect)
	{
		dc.SetPen(*wxTRANSPARENT_PEN);
#ifdef __WXMAC__
...
#define wxFloatingPaneBaseClass wxFrame
	...
	public:
		...
		//##ModelId=44B8E82D000F
		~wxFloatingPane()
		{
			m_mgr.UnInit();
		}

		//##ModelId=44B8E82D0148
	...
	private:
		...
		//##ModelId=44B8E82D029F
		void OnSize(wxSizeEvent& event)
		{
			m_owner_mgr->OnFloatingPaneResized(m_pane_window, event.GetSize());
		}

		//##ModelId=44B8E82D03C8
	...
	private:
		//##ModelId=44B8E8300178
		wxWindow* m_pane_window;    // pane window being managed
		//##ModelId=44B8E8300290
		bool m_moving;
		//##ModelId=44B8E83003AA
		wxRect m_last_rect;
		//##ModelId=44B8E83100EB
		wxSize m_last_size;

		//##ModelId=44B8E8310214
		wxFrameManager* m_owner_mgr;
		//##ModelId=44B8E831033D
